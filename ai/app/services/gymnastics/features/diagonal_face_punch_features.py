...
class DiagonalFacePunchFeatureSet:
...
def extract_diagonal_face_punch_features(
    ...
    effective_left_baseline = (
        raw_left_wrist_forward if baseline_left_wrist_forward is None else baseline_left_wrist_forward
    )
    effective_right_baseline = (
        raw_right_wrist_forward if baseline_right_wrist_forward is None else baseline_right_wrist_forward
    )
    ...
    return DiagonalFacePunchFeatureSet(
