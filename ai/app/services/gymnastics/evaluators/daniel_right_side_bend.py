...
from app.services.gymnastics.constants import (
    ...
    DEFAULT_DANIEL_RIGHT_SIDE_BEND_ARM_STRAIGHT_THRESHOLD,
    DEFAULT_DANIEL_RIGHT_SIDE_BEND_TILT_THRESHOLD,
    DEFAULT_DANIEL_RIGHT_SIDE_BEND_WRIST_HEIGHT_THRESHOLD,
...
class DanielRightSideBendEvaluatorConfig:
    target_hold_ms: int = DEFAULT_STRETCH_HOLD_TARGET_MS
    max_frame_gap_ms: int = DEFAULT_HOLD_MAX_FRAME_GAP_MS
    tilt_threshold: float = DEFAULT_DANIEL_RIGHT_SIDE_BEND_TILT_THRESHOLD
    wrist_height_threshold: float = DEFAULT_DANIEL_RIGHT_SIDE_BEND_WRIST_HEIGHT_THRESHOLD
    arm_straight_threshold: float = DEFAULT_DANIEL_RIGHT_SIDE_BEND_ARM_STRAIGHT_THRESHOLD
...
class DanielRightSideBendEvaluator(BaseHoldEvaluator):
    motion_id = "daniel_side_bend_right"
    motion_name = DANIEL_RIGHT_SIDE_BEND_MOTION_NAME

    def __init__(self, config: DanielRightSideBendEvaluatorConfig | None = None):
        self.config = config or DanielRightSideBendEvaluatorConfig()
        super().__init__(
            HoldEvaluatorConfig(
    ...
    def _compute_accuracy(
        self,
        features: DanielRightSideBendFeatureSet,
