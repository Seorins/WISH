...
from app.services.gymnastics.constants import (
    DEFAULT_DIAGONAL_BODY_PUNCH_ARM_STRAIGHT_THRESHOLD,
    DEFAULT_DIAGONAL_BODY_PUNCH_DEPTH_SHIFT_MAX,
    DEFAULT_DIAGONAL_BODY_PUNCH_DOMINANCE_MARGIN,
    DEFAULT_DIAGONAL_BODY_PUNCH_FORWARD_THRESHOLD,
    DEFAULT_DIAGONAL_BODY_PUNCH_GUARD_BEND_THRESHOLD,
    DEFAULT_DIAGONAL_BODY_PUNCH_RELEASE_THRESHOLD,
    DEFAULT_DIAGONAL_BODY_PUNCH_STANCE_SPAN_THRESHOLD,
    DEFAULT_DIAGONAL_BODY_PUNCH_TARGET_STEPS,
    DEFAULT_DIAGONAL_BODY_PUNCH_TORSO_TILT_MAX,
...
class DiagonalBodyPunchEvaluatorConfig:
    target_steps: int = DEFAULT_DIAGONAL_BODY_PUNCH_TARGET_STEPS
    forward_threshold: float = DEFAULT_DIAGONAL_BODY_PUNCH_FORWARD_THRESHOLD
    stance_span_threshold: float = DEFAULT_DIAGONAL_BODY_PUNCH_STANCE_SPAN_THRESHOLD
    dominance_margin: float = DEFAULT_DIAGONAL_BODY_PUNCH_DOMINANCE_MARGIN
    release_threshold: float = DEFAULT_DIAGONAL_BODY_PUNCH_RELEASE_THRESHOLD
    arm_straight_threshold: float = DEFAULT_DIAGONAL_BODY_PUNCH_ARM_STRAIGHT_THRESHOLD
    guard_bend_threshold: float = DEFAULT_DIAGONAL_BODY_PUNCH_GUARD_BEND_THRESHOLD
    torso_tilt_max: float = DEFAULT_DIAGONAL_BODY_PUNCH_TORSO_TILT_MAX
    depth_shift_max: float = DEFAULT_DIAGONAL_BODY_PUNCH_DEPTH_SHIFT_MAX
...
class DiagonalBodyPunchEvaluator(BaseEvaluator):
    motion_id = "diagonal_body_punch"

    def __init__(self, config: DiagonalBodyPunchEvaluatorConfig | None = None):
        self.config = config or DiagonalBodyPunchEvaluatorConfig()
    ...
    def _resolve_next_state(
        ...
        if previous_state == "left_punch" and not left_armed:
            if features.left_wrist_forward > self.config.release_threshold:
                return "left_punch"

        if previous_state == "right_punch" and not right_armed:
            if features.right_wrist_forward > self.config.release_threshold:
                return "right_punch"
    ...
    def _stabilize_feedback(
        ...
        candidate = select_diagonal_body_punch_feedback_candidate(
            features=features,
            state=state,
            tracking=tracking,
