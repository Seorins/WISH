...
<table>
    ...
    <tr>
      ...
      <td width="280px" valign="top">
        <sub>
          - Phaser 3 기반 미술·음악 테마 콘텐츠 화면 구현<br>
          - 자유 그림·색칠하기 및 MediaPipe 손동작 입력 연동<br>
          - STOMP 기반 실시간 캐치마인드 멀티플레이 구현<br>
          - 리듬게임 차트·콤보·판정 및 YouTube 음원 연동<br>
          - 플레이 영상·썸네일 생성 및 S3 업로드 연동<br>
          - React 기반 보호자 페이지 및 활동 데이터 시각화<br>
          - Three.js 기반 3D 동작 리플레이·관절 분석 UI 구현<br>
          - AI 주간 리포트 및 SSE·LiveKit 실시간 모니터링 구현
      </td>
    </tr>
