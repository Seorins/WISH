...
public enum ExerciseErrorCode implements ErrorCode {
    ...
    EXERCISE_SESSION_MOTION_REQUIRED(
            HttpStatus.BAD_REQUEST, "EX-004", "체조 세션에는 최소 1개 이상의 동작 결과가 필요합니다."),
    EXERCISE_SESSION_MOTION_TYPE_MISMATCH(
            HttpStatus.BAD_REQUEST, "EX-005", "세션 체조 타입과 동작 체조 타입이 일치하지 않습니다.");
